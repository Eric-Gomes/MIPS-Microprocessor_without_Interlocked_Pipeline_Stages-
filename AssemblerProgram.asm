#Eric Gomes, 15115434, All options 1-12 implemented

.data
#Program menu for the user
menu:   .ascii "\n"
        .ascii "\t1: Set a value for Number 1\n"
        .ascii "\t2: Set a value for Number 2\n"
        .ascii "\t3:  Display the values for Number 1 and Number 2\n"
	.ascii "\t4:  Display the sum for Number 1 and Number 2\n"
	.ascii "\t5:  Display the product for Number 1 and Number 2\n"
	.ascii "\t6:  Divide Number 1 by Number 2 and display the quotient and remainder\n"
	.ascii "\t7:  Swap the values of Number 1 and Number 2\n"
	.ascii "\t8:  Display the numbers in sequence between and including Number 1 and Number 2\n"
